...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='/home/hutao/VesselSeg-Pytorch-master/data_1/ISIC2018/ISIC2018_jpg/', help='the path of images')
    ...
    model_ft = GCGLEUnet(img_size=256,in_chans=3, num_classes=1, n_win=8)
    model_ft.load_from()
    ...
    exp_lr_scheduler = lr_scheduler.CosineAnnealingLR(optimizer_ft, 250, eta_min=0, last_epoch=-1, verbose=False)
