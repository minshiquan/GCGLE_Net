...
from networks.bra_unet import GCGLENetSystem
...
parser.add_argument('--list_dir', type=str,
                    default='/home/hutao/VesselSeg-Pytorch-master/model1/acdc_list1/', help='list dir')
...
if __name__ == "__main__":
    ...
    net = GCGLENetSystem(img_size=224, in_chans=3, num_classes=4, n_win=7)
    net = net.cuda() 
    #net.load_from()
