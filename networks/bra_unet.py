...
from networks.bra_unet_system import GCGLENetSystem
logger = logging.getLogger(__name__)
class GCGLEUnet(nn.Module):
    def __init__(self, img_size=256, in_chans=3, num_classes=1, n_win=8):
        super(GCGLEUnet, self).__init__()
        self.bra_unet = GCGLENetSystem(img_size=img_size,
                                      in_chans=in_chans,
    ...
    def forward(self, x):
        ...
        return logits
    def load_from(self):
        pretrained_path = '/home/hutao/GCGLE_Net/biformer_base_best.pth'
