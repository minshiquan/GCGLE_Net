...
class LEB1(nn.Module):

    def __init__(self,x):

        super(LEB1,self).__init__()

        self.conv1 = nn.Conv2d(x,x,kernel_size=3,stride=1,padding=1)

        self.con2 = nn.Conv2d(x,x,kernel_size=3,stride=1,padding=1)
...
class Block(nn.Module):
    def __init__(self, dim, input_resolution, drop_path=0., layer_scale_init_value=-1,num_heads=8, n_win=7, qk_dim=None, qk_scale=None,
        ...
        self.mlp = LEB(in_chans=dim,out_chans=dim)
